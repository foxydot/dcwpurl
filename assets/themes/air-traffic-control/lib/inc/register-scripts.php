...
function msdlab_get_the_style_selector($post){
	if($post==NULL){
		global $post;
	}
	//TODO: Create custom meta box to sit under page attributes containing style selector, auto generated from stylesheets registered via inclusion in specified folder
	//TODO: Naming convention?
	//TODO: Get result from that meta box to go here
	return $style;
}

function msdlab_add_styles() {
	//TODO: Modify style/js to include specific registered style requested by custom meta.
    global $is_IE;
    if(!is_admin()){
        //use cdn        
