<?php
/*
Template Name: Orange Landing Page
*/
...
function orange_add_styles() {
    ...
    if(!is_admin()){
        ...
        wp_enqueue_style('msd-style',get_stylesheet_directory_uri().'/lib/orange-landing-page/css/style.css',$queue);
        $queue[] = 'msd-style';
        if(is_front_page()){
            wp_enqueue_style('msd-homepage-style',get_stylesheet_directory_uri().'/lib/orange-landing-page/css/homepage.css',$queue);
            $queue[] = 'msd-homepage-style';
        } else {
            wp_enqueue_style('msd-landingpage',get_stylesheet_directory_uri().'/lib/orange-landing-page/css/landingpage.css',$queue);
            $queue[] = 'msd-landingpage';
        }
        if($is_IE){
            wp_enqueue_style('ie-style',get_stylesheet_directory_uri().'/lib/orange-landing-page/css/ie.css',$queue);
            $queue[] = 'ie-style';
            
            wp_enqueue_style('ie8-style',get_template_directory_uri() . '/lib/orange-landing-page/css/ie8.css');
            global $wp_styles;
